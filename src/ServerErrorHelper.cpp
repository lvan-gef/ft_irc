...
void Server::_handleError(IRCMessage token,
    ...
    switch (error) {
        ...
        case IRCCodes::NOSUCHNICK:
            client->appendMessageToQue(formatMessage(":", _serverName, " ",  errnoAsString,
                                       token.params[0],
        ...
        case IRCCodes::NORECIPIENT:
            client->appendMessageToQue(formatMessage(":", _serverName, " ", errnoAsString,
                                       token.params[0], " :No recipient given ",
                                       token.command));
            break;
        ...
        case IRCCodes::NICKINUSE: {
            ...
            client->appendMessageToQue(formatMessage(":", _serverName, " ", errnoAsString, clientNick,
                                       token.params[0],
